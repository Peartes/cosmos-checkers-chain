...
import { MsgDeleteGame } from "./types/checkers/tx";
import { MsgCreateGame } from "./types/checkers/tx";


const types = [
  ["/alice.checkers.checkers.MsgDeleteGame", MsgDeleteGame],
...
const txClient = async (wallet: OfflineSigner, { addr: addr }: TxClientOptions = { addr: "http://localhost:26657" }) => {
  ...
  return {
    ...
    msgDeleteGame: (data: MsgDeleteGame): EncodeObject => ({ typeUrl: "/alice.checkers.checkers.MsgDeleteGame", value: MsgDeleteGame.fromPartial( data ) }),
