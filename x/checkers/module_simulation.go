...
func (am AppModule) WeightedOperations(simState module.SimulationState) []simtypes.WeightedOperation {
	...
	simState.AppParams.GetOrGenerate(simState.Cdc, opWeightMsgDeleteGame, &weightMsgDeleteGame, nil,
		func(_ *rand.Rand) {
	...
	operations = append(operations, simulation.NewWeightedOperation(
		weightMsgDeleteGame,
		checkerssimulation.SimulateMsgDeleteGame(am.accountKeeper, am.bankKeeper, am.keeper),
	))
